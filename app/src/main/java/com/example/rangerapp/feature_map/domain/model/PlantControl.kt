...
data class PlantControl(
    ...
    override fun toJson(): JSONObject {
        ...
        rootObject.put("type", MapEntryType.PLANT_CONTROL)
    ...
    override fun getMapEntryType(): MapEntryType {
        return MapEntryType.PLANT_CONTROL
    }

    override fun importEquals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is PlantControl) return false
    ...
    override fun getTitle(): String {
        return MapEntryType.PLANT_CONTROL.value + " - " + createdTimestamp.toString()
    }

}

class InvalidPlantControlException(message: String) : Exception(message)